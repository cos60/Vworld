...
router.get('/',async (ctx)=>{
    var result = await DB.find('agency',{})


    ctx.render('default/hotel',{
        agency:result
    })
})
...
router.get('/agencyDet',async (ctx)=>{

    var id = ctx.query.id;

    var result =await DB.find('activity',{'author':id});
    console.log(id);
    ctx.render('default/agencyDet',{
        activity:result
    })
})
